<style>
    ...
    .quote_bar_icon_m:hover .icon_frame_m{
        fill: var(--font-white, #EAEAEA);
    }

    .quote_bar_icon_m:active{
        border-radius: .8vw;
        border:.26vw #EAEAEA solid;
        background: var(--font-white, #EAEAEA);
    }

    .quote_bar_icon_m:active .icon_frame_m{
    ...
    .quote_bar_icon_s:hover .icon_frame_s{
        fill: var(--font-white, #EAEAEA);
    }

    .quote_bar_icon_s:active{
        border-radius: .26vw;
        border:.13vw #EAEAEA solid;
        background: var(--font-white, #EAEAEA);
    }

    .quote_bar_icon_s:active .icon_frame_s{
        fill: var(--font-white, #CAC0A8);
    }
...
<a href="{{route($link_to, $id)}}">
    @if ($icon === "bookmark")
        <div class="quote_bar_icon_m">
            <div class="icon_frame_m">
                <svg xmlns="http://www.w3.org/2000/svg" width="1vw" height="1.32vw" viewBox="0 0 16 20" id="bookmark">
                    <path d="M0.5 1.875V19.0508C0.5 19.5742 0.925781 20 1.44922 20C1.64453 20 1.83594 19.9414 1.99609
                    19.8281L8 15.625L14.0039 19.8281C14.1641 19.9414 14.3555 20 14.5508 20C15.0742 20 15.5 19.5742 15.5
                    19.0508V1.875C15.5 0.839844 14.6602 0 13.625 0H2.375C1.33984 0 0.5 0.839844 0.5 1.875Z"/>
                </svg>
            </div>
        </div>
    @elseif ($icon === "book")
        <div class="quote_bar_icon_m" >
            <div class="icon_frame_m">
                <svg xmlns="http://www.w3.org/2000/svg" width="1.32vw" height="1vw" viewBox="0 0 20 16" id="openbook">
                    <path d="M8.66667 15.6135C9.04167 15.7454 9.44444 15.4711 9.44444 15.0753V1.97111C9.44444 1.82528
                    9.38889 1.67944 9.27083 1.58917C8.59028 1.0475 7.02778 0.353054 5 0.353054C3.24653 0.353054 1.60764
                    0.81486 0.628472 1.18986C0.236111 1.34264 0 1.73153 0 2.15167V15.0093C0 15.4225 0.444444 15.7107
                    0.836806 15.5822C1.93056 15.2176 3.66319 14.7975 5 14.7975C6.17708 14.7975 7.74306 15.2836 8.66667
                    15.6135ZM11.3333 15.6135C12.2569 15.2836 13.8229 14.7975 15 14.7975C16.3368 14.7975 18.0694 15.2176
                    19.1632 15.5822C19.5556 15.7142 20 15.4225 20 15.0093V2.15167C20 1.73153 19.7639 1.34264 19.3715
                    1.19333C18.3924 0.81486 16.7535 0.353054 15 0.353054C12.9722 0.353054 11.4097 1.0475 10.7292
                    1.58917C10.6146 1.67944 10.5556 1.82528 10.5556 1.97111V15.0753C10.5556 15.4711 10.9618 15.7454
                    11.3333 15.6135Z"/>
                </svg>
            </div>
        </div>
    ...
    @elseif ($icon === "create")
        <div class="quote_bar_icon_m" >
            <div class="icon_frame_m">
                <svg xmlns="http://www.w3.org/2000/svg" width="1.32vw" height="1.32vw" viewBox="0 0 20 20" id="create">
    ...
    @elseif ($icon === "delete")
        <div class="quote_bar_icon_m" >
            <div class="icon_frame_m">
                <svg xmlns="http://www.w3.org/2000/svg" width="1.19vw" height="1.32vw" viewBox="0 0 18 20" id="delete">
                    <path d="M5.53125 0.691406C5.74219 0.265625 6.17578 0 6.64844 0H11.3516C11.8242 0 12.2578 0.265625 12.4688 0.691406L12.75 1.25H16.5C17.1914 1.25 17.75 1.80859 17.75 2.5C17.75 3.19141 17.1914 3.75 16.5 3.75H1.5C0.808594 3.75 0.25 3.19141 0.25 2.5C0.25 1.80859 0.808594 1.25 1.5 1.25H5.25L5.53125 0.691406ZM1.5 5H16.5V17.5C16.5 18.8789 15.3789 20 14 20H4C2.62109 20 1.5 18.8789 1.5 17.5V5ZM5.25 7.5C4.90625 7.5 4.625 7.78125 4.625 8.125V16.875C4.625 17.2188 4.90625 17.5 5.25 17.5C5.59375 17.5 5.875 17.2188 5.875 16.875V8.125C5.875 7.78125 5.59375 7.5 5.25 7.5ZM9 7.5C8.65625 7.5 8.375 7.78125 8.375 8.125V16.875C8.375 17.2188 8.65625 17.5 9 17.5C9.34375 17.5 9.625 17.2188 9.625 16.875V8.125C9.625 7.78125 9.34375 7.5 9 7.5ZM12.75 7.5C12.4062 7.5 12.125 7.78125 12.125 8.125V16.875C12.125 17.2188 12.4062 17.5 12.75 17.5C13.0938 17.5 13.375 17.2188 13.375 16.875V8.125C13.375 7.78125 13.0938 7.5 12.75 7.5Z"  />
                </svg>
            </div>
        </div>
    @elseif ($icon === "shelf_create")
        <div class="quote_bar_icon_m" >
            <div class="icon_frame_m">
                <svg xmlns="http://www.w3.org/2000/svg" width="1.85vw" height="1.85vw" viewBox="0 0 28 28">
                    <path d="M22.4 0C22.8765 0 23.2615 0.405263 23.2615 0.906883V4.98785H27.1385C27.615 4.98785 28 5.39312 28 5.89474C28 6.39636 27.615 6.80162 27.1385 6.80162H23.2615V10.8826C23.2615 11.3842 22.8765 11.7895 22.4 11.7895C21.9235 11.7895 21.5385 11.3842 21.5385 10.8826V6.80162H17.6615C17.185 6.80162 16.8 6.39636 16.8 5.89474C16.8 5.39312 17.185 4.98785 17.6615 4.98785H21.5385V0.906883C21.5385 0.405263 21.9235 0 22.4 0Z"  />
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M1.40001 10.3158C2.17321 10.3158 2.80001 10.9756 2.80001 11.7895L2.80001 16.2105L25.2 16.2105V11.7895C25.2 10.9756 25.8268 10.3158 26.6 10.3158C27.3732 10.3158 28 10.9756 28 11.7895V26.5263C28 27.3402 27.3732 28 26.6 28C25.8268 28 25.2 27.3402 25.2 26.5263H2.8C2.8 27.3402 2.1732 28 1.4 28C0.6268 28 0 27.3402 0 26.5263L1.10149e-05 11.7895C1.16162e-05 10.9756 0.626813 10.3158 1.40001 10.3158ZM2.8 23.5789L2.8 19.1579L25.2 19.1579V23.579L2.8 23.5789Z"  />
                </svg>
            </div>
        </div>
    @elseif ($icon === "firstpage")
        <div class="quote_bar_icon_s" >
            <div class="icon_frame_s">
                <svg xmlns="http://www.w3.org/2000/svg" width="1.32vw" height="1vw" viewBox="0 0 20 16" id="firstpage">
    ...
    @elseif ($icon === "previouspage")
        <div class="quote_bar_icon_s" >
            <div class="icon_frame_s">
                <svg xmlns="http://www.w3.org/2000/svg" width="0.66vw" height="1vw" viewBox="0 0 10 16" id="previouspage">
                    <path d="M0.939392 9.05945C0.353699 8.47376 0.353699 7.52259 0.939392 6.9369L6.93689 0.9394C7.36796 0.50833 8.00988 0.38182 8.57215 0.616097C9.13441 0.850375 9.49989 1.3939 9.49989 2.00302V13.998C9.49989 14.6025 9.13441 15.1507 8.57215 15.3849C8.00988 15.6192 7.36796 15.488 6.93689 15.0616L0.939392 9.06414V9.05945Z"  />
                </svg>
            </div>
        </div>
    ...
    @elseif ($icon === "lastpage")
        <div class="quote_bar_icon_s" >
            <div class="icon_frame_s">
                <svg xmlns="http://www.w3.org/2000/svg" width="1.32vw" height="1.05vw" viewBox="0 0 20 16" id="p">
