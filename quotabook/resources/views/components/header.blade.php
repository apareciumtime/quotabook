<head>
    ...
    <style>
        ...
        /* .header_box_logo:hover logo {
            background: #FEFEFE;
            fill: var(--click, #CAC0A8);;
        } */
    ...
    <div class="header_box">
        <a href="{{ route('home') }}">
            <div class="header_box_logo">
                <svg id="logo" xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64" fill="none">
        ...
        <div class="welcoming">ยินดีต้อนรับสู่ QuotabooK</div>
